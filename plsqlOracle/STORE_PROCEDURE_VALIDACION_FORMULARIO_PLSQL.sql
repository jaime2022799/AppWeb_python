...
--EXECUTE VALIDACION_INSERT_FORMULARIO_ADMINISTRATIVO('JAIME','MENDOZA','AUTOMOTRIZ','990383275','JOAQUIN PALACIOS','MENDOZA@GMAIL.COM','07/08/24','17:19');

--SELECT * FROM formulario_administrativo WHERE FECHA = '07/08/24';